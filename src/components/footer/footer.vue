<template>
    <section v-show="device !== 'h5'" id='foot_guide'>
        <div>
        ...
        <section @click = "gotoAddress({path: '/state', query: {geohash}})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('msite') !== -1? '#index' : '#msite'"></use>
            </svg>
            <span>上报</span>
        </section>
        <section @click = "gotoAddress({path: `/situation`})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('search') !== -1? '#findActive' : '#find'"></use>
            </svg>
            <span>态势</span>
        </section>
        <section @click = "gotoAddress('/data')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('order') !== -1? '#orderActive' : '#order'"></use>
            </svg>
            <span>数据</span>
        </section>
        <section @click = "gotoAddress('/index')" class="guide_item">
        	<svg class="icon_style">
