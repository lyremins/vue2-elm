<template>
    ...
    <div class="sheet-list">
        ...
        <div class="sheet-header" @click="toggleSheet">
            <i class="icon iconfont icon-enter" ref="toggleicon"></i>   <span class="sheet-header-span">装备名称{{data_item.filed1}} <span></span></span>
        ...
        <div v-if="showSheets" class="sheet-content">
            ...
            <div class="sheet-content-middle">
                ...
                <p style="">{{data_item.filed1}}</p>
                <p style="">{{data_item.filed2}}</p>
                <p style="">{{data_item.filed3}}</p>
                <p style="">{{data_item.filed4}}</p>
                <p style="">{{data_item.filed5}}</p>
                <p style="">{{data_item.filed6}}</p>
